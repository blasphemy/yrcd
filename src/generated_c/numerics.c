...
yrcdNumericWrapper* yrcd_numeric_wrapper_construct (GType object_type) {
	...
	gee_abstract_map_set ((GeeAbstractMap*) _tmp5_, (gpointer) ((gintptr) YRCD_RPL_LISTSTART), "Channel :Users Name");
	_tmp6_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp6_, (gpointer) ((gintptr) YRCD_RPL_LIST), "%s %d :%s");
	_tmp7_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp7_, (gpointer) ((gintptr) YRCD_RPL_LISTEND), ":End of channel list");
	_tmp8_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp8_, (gpointer) ((gintptr) YRCD_RPL_TOPIC), "%s :%s");
	_tmp9_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp9_, (gpointer) ((gintptr) YRCD_RPL_TOPICWHOTIME), "%s %s %d");
	_tmp10_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp10_, (gpointer) ((gintptr) YRCD_RPL_WHOREPLY), "%s %s %s %s %s %s %s %s");
	_tmp11_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp11_, (gpointer) ((gintptr) YRCD_RPL_NAMEPLY), "= %s :%s");
	_tmp12_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp12_, (gpointer) ((gintptr) YRCD_RPL_ENDOFNAMES), "%s :End of /NAMES list.");
	_tmp13_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp13_, (gpointer) ((gintptr) YRCD_RPL_MOTD), ":- %s");
	_tmp14_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp14_, (gpointer) ((gintptr) YRCD_RPL_MOTDSTART), ":- %s Message of the day -");
	_tmp15_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp15_, (gpointer) ((gintptr) YRCD_RPL_ENDOFMOTD), ":End of /MOTD command.");
	_tmp16_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp16_, (gpointer) ((gintptr) YRCD_ERR_NOSUCHCHANNEL), "%s :No such channel");
	_tmp17_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp17_, (gpointer) ((gintptr) YRCD_ERR_UNKNOWNCOMMAND), "%s :Unkown command");
	_tmp18_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp18_, (gpointer) ((gintptr) YRCD_ERR_NONICKNAMEGIVEN), "No nickname given");
	_tmp19_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp19_, (gpointer) ((gintptr) YRCD_ERR_NICKNAMEINUSE), "%s :Nickname is already in use");
	_tmp20_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp20_, (gpointer) ((gintptr) YRCD_ERR_ERRONEOUSNICKNAME), "%s :Erroneous nickname");
	_tmp21_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp21_, (gpointer) ((gintptr) YRCD_ERR_NOTREGISTERED), ":You have not registered");
	_tmp22_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp22_, (gpointer) ((gintptr) YRCD_ERR_NEEDMOREPARAMS), "%s :Not enough parameters");
	_tmp23_ = self->numerics;
	gee_abstract_map_set ((GeeAbstractMap*) _tmp23_, (gpointer) ((gintptr) YRCD_ERR_ALREADYREGISTRED), "You may not reregister");
	return self;
}
